...
import com.gosun.uid.BitsAllocator;
import com.gosun.uid.UidGenerator;
import com.gosun.uid.exception.UidGenerateException;
import com.gosun.uid.utils.DateUtils;
import com.gosun.uid.worker.WorkerIdAssigner;
...
public class DefaultUidGenerator implements UidGenerator, InitializingBean {
    ...
    /** Bits allocate */
    @Value(value="${com.gosun.xone.uid.timeBits}")
    protected int timeBits = 28;
    @Value(value="${com.gosun.xone.uid.workerBits}")
    protected int workerBits = 22;
    @Value(value="${com.gosun.xone.uid.seqBits}")
